= Prüfschritt 1.4.11a Kontraste von Grafiken und Bedienelementen ausreichend
...
{empty}1. Screenshots erstellen (ggf. vorher Zoomfunktion nutzen, siehe Handreichung)

{empty}2. Screenshots an den PC übertragen.

{empty}3. Screenshots am PC öffnen und mit dem Contrast-Analyzer untersuchen.
