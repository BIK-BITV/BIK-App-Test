...
Verwenden Sie einen Screenreader, um den zugänglichen Namen jedes Bedienelements für den Vergleich mit dem Text der sichtbaren Beschriftung zu ermitteln. (Beachten Sie, dass die Screenreader-Ausgabe Informationen enthalten kann, die nicht Teil des zugänglichen Namens sind, zum Beispiel die Rolle des Bedienelements oder eine zusätzliche Beschreibung.).
...
Zu beachten ist, dass bei den meisten mobilen Apps nur ein Test mittels Screenreader Aufschluss über den Accessible-Name gibt. Zukünftig könnten Systeme zur Sprachsteuerung wie Apples VoiceControl als Prüfwerkzeug berücksichtigt werden.
...
* https://www.w3.org/TR/accname/#mapping_additional_nd_te[Accessible Name and Description Computation: https://www.w3.org/TR/accname/#mapping_additional_nd_te (zur Zeit nur auf Englisch verfügbar)]
