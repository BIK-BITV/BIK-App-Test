...
Überschriften müssen als solche ausgezeichnet sein und die Inhalte der Seite
erschließen.
...
Gliederung der App-Inhalte , damit diese leicht zu erfassen und mit
Hilfsmitteln wie Screenreadern zu überspringen sind.

Im Prüfschritt
<<2.4.1a Bereiche überspringbar.adoc#,2.4.1a Bereiche überspringbar>>
geht es dagegen vorrangig um die *Strukturierung* der Ansichten durch
Überschriften.
...
Quelle: http://www.w3.org/TR/WCAG20-TECHS/H42.html[WCAG 2.0 Technik H42: Using
