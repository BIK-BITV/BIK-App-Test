...
* Apple Developer Documentation: https://developer.apple.com/documentation/swiftui/text/accessibilityheading(_:)[accessibilityHeading(_:)] (Hierarchische Überschriften in iOS)
