...
==== 3.1. Hinweise für Entwicklungs-Teams:

* Für native Apps unter iOS / iPadOS das 
...
`UIAccessibilityTraits`] für die Auszeichnung von Überschriften verwendet.

* Für nativen Apps unter Android das Attribut
...
* Apple Developer Documentation: https://developer.apple.com/documentation/swiftui/text/accessibilityheading(_:)[Hierarchische Überschriften in iOS] mittels `accessibilityHeading(_:)`
...
https://www.w3.org/WAI/WCAG21/Techniques/general/G141[WCAG 2.1, G141: Organizing a page using headings]
...
https://www.w3.org/WAI/WCAG21/Techniques/html/H42.html[WCAG 2.1, H42: Using
