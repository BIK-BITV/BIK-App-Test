...
Für die Vermittlung von Informationen sind keine Schriftgrafiken zu verwenden,
es sei denn,

diese lassen sich individuell an die visuellen Bedürfnisse der Nutzerin oder
des Nutzers anpassen oder eine bestimmte Präsentation ist für die
Vermittlung der Informationen des Textes wesentlich.
