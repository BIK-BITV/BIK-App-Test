...
{empty}2. Formularelemente (Checkboxes, Radio Buttons, Auswahllisten) ausprobieren. Werden unerwartete und nicht angekündigte Kontextänderungen erzeugt?

{empty}3. Überprüfen, ob Inhaltsänderungen hervorgerufen werden (etwa Einblendungen zusätzlicher Formularfelder). Sind die Inhaltsänderungen begrenzt und gut nachvollziehbar oder werden vor dem auslösenden Element angekündigt bzw. erklärt?

{empty}4. Prüfen, ob Inhaltsänderungen unterhalb des Elements, das sie auslöst, hervorgerufen werden.

{empty}5. Prüfen, ob durch Formulareingaben hervorgerufene Kontextänderungen (etwa dynamisch eingeblendete Elemente) den aktuellen Fokus versetzen.

=== Hinweise

Folgendes gilt ebenfalls vergleichbar für Software. Auftretende modale Dialoge müssen dabei barrierefrei sein.
...
Hinweis: Die Technik G80 ist SC 3.2.2 zugeordnet, wird aber nur indirekt geprüft.
...
Hinweis: Die Technik H32 ist SC 3.2.2 zugeordnet, wird aber nur indirekt geprüft.
