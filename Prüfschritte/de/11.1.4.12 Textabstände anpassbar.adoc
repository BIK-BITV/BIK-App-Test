...
Falls Apps selbst Einstellungen für die Textspreizung bieten, sind dies von Autoren vorgesehene und implementierte Einstellungen, es geht also nicht um die generelle Anpassbarkeit von App-Inhalten an Einstellungen von Nutzenden. Solche Einstellungen fallen deshlb nicht unter diesen Prüfschritt, sondern sind als alternative Versionen zur konformen Version zu bewerten.
