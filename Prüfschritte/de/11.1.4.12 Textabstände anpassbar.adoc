...
=== Anmerkung ===
Die Anforderung verlangt *nicht* von Autoren, die genannten Werte bei Ihren Inhalten umzusetzen oder solche Einstellungsmöglichekeiten in der App selbst anzubieten, sondern lediglich, dass von Nutzenden in der Plattform vorgenommene Anpassungen nicht zum Abschneiden von Text oder Verlust von Funktionalitäten führt.
