...
Der Prüfschritt ist anwendbar, wenn die App ein Autorenwerkzeug ist oder Elemente eines Autorenwerkzeugs integriert und das Zielformat sselbst in der App selbst darin angezeigt wird bzw. aufrufbar ist (auch etwa als HTML-Datei innerhalb eines Webviews). Für andere Zielformate wie PDF mss ggf. eine getrennte Prüfung vorgenommen werden.
