...
Der klassische Fall wäre die Prüfung eines webbasierten Content Management Systems für die Erstellung von Webseiten. Aber auch Kommentarfunktionen lassen sich als in Apps integriertes Autorenwerkzeug betrachten.
