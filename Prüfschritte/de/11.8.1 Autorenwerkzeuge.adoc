...
Der klassische Fall wäre die Prüfung eines webbasierten Content Management Systems für die Erstellung von Webseiten. Aber aucheine Kommentarfunktion lässt sich als ein in die App integriertes Autorenwerkzeug betrachten.
