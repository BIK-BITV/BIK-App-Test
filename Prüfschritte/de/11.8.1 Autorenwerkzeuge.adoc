...
Ein Beispiel eines Autorenerkzeugs wäre eine native App zur Texterstellung und Bearbeitung. Aber auch eine Kommentarfunktion in einer App lässt sich als ein (stark reduzuertes) Autorenwerkzeug betrachten.
