...
Beim Navigieren auf der Seite darf es daher nicht zu Situationen kommen, in denen Web-Inhalte das fokussierte Element vollständig verdecken. So können etwa fest positionierte Kopf- und Fußbereiche die fokussierten Bedienelemente und deren Fokusindikator überlagern. 
