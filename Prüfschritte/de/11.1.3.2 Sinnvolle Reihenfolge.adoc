...
=== 3. Hinweise
Bei interaktiven Widgets wie der Reiternavigation (Tableiste am unteren oder oberen Bildschirmrand) gibt es unterschiedliche Konventionen bezüglich der Fokusversetzung in den jeweils eingeblendeten Inhaltsbereich, die damit auch die Lesereihenfolge prägen.
