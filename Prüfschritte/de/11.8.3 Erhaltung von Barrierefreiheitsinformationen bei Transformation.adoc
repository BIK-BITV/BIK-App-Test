...
Wenn die Software ein Autorenwerkzeug ist und Umstrukturierungen oder Funktionen zur Neucodierung bietet, dann werden die Informationen zur Zugänglichkeit in der Ausgabe, wenn gleichwertige Mechanismen zur Speicherung der Zugänglichkeitsinformationen im Zieldokumententyp der Ausgabe existieren,
übernommen.
...
Der Prüfschritt ist anwendbar, wenn die App ein Autorenwerkzeug ist und Umstrukturierungen (Restrukturierungstransformationen) oder Funktionen zur Neucodierung bietet.
...
. Beispieldokument in der App öffnen und in das Zielformat bzw. in eine andere Struktur umgewandeln.
...
Die Schritte müssen für jedes Ein- und Ausgangsformat, das die App für die Transformation unterstützt, wiederholt werden.

Auch wenn die App lediglich die Struktur des Eingangsdokuments verändert, muss sichergestellt werden, dass die Ausgangsdatei noch alle, für die Barrierefreiheit relevanten, Informationen enthält.
