...
Der Prüfschritt ist anwendbar, wenn die App ein Autorenwerkzeug ist und Umstrukturierungen oder Funktionen zur Umcodierung bietet (etwa den Export von Informationen als PDF-Datei).
