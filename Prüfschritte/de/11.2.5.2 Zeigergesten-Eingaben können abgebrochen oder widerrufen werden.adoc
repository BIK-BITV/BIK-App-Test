...
== Quellen
=== Allgemein
* WCAG 2.1: https://www.w3.org/WAI/WCAG21/Understanding/pointer-cancellation.html{Understanding SC 2.5.2 Pointer Cancellation]
* Appt.org: https://appt.org/en/guidelines/wcag/success-criterion-2-5-2#support-input-cancellation[Pointer Cancellation: Support inout cancellation]
=== iOS

=== Android
* Appt.org: https://appt.org/en/docs/android/samples/input-cancellation[Input cancellation on Android]

===  Allgemeine Quellen (WCAG und Spezifikationen)
