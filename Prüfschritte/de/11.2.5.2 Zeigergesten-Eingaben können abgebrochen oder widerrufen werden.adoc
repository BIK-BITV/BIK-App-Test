...
* Appt.org: https://appt.org/en/guidelines/wcag/success-criterion-2-5-2#support-input-cancellation[Pointer Cancellation: Support inout cancellation] (mehrere Entwickungsumgebungen)
...
=== iOS
* Appt.org: https://appt.org/en/docs/ios/samples/input-cancellation[>INout cancellation on iOS]
