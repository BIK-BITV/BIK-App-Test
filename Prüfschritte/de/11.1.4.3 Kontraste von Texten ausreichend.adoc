...
==== 3.2 Hinweise zur Berechnung der Schriftgröße
...
. Screenshot in einem Grafik-Programm laden, den Screenshot auf die errechnete CSS Viewport-Breite verkleinern (in dem genannten Beispiel 414 CSS Pixel).
...
==== 3.4 Hinweise zur Prüfung von Ansichten mit Styleswitcher
