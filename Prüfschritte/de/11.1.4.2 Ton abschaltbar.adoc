...
Falls ein Tonelement nach dem starten einer App automatisch abgespielt wird, ist es deshalb wichtig, dass es sich über einen am Beginn der Ansicht befindlichen barrierefreien Mechanismus abschalten, anhalten oder herunter
regeln lässt.
...
Der Prüfschritt ist anwendbar, wenn nach dem starten einer App bzw. beim Wechsel auf die zu prüfende Ansicht Tonelemente automatisch länger als drei Sekunden abgespielt werden.

=== 2. Prüfung

Wenn nach Starten der App bzw. beim Wechsel auf die zu prüfende Ansicht
