...
Wenn eine App Videotelefonie unterstützt, soll nicht nur die Aktivtät von Sprechenden, sondern auch die von Gebärdensprach-Eingebenden angezeigt werden.
...
* Wahrnehmbarkeit schließt visuelle Wahrnehmbarkeit und ptogrammatische Ermittelbarkeit der Aktivitätsanzeige ein.
