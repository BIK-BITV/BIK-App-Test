...
Der Prüfschritt ist immer anwendbar, wenn die Accessibility Baseline Umgebungen einschließt, die bei Tastaturnutzung keine Einfingerbedienung anbieten (z.B. Android). Das Ergebnis ist ggf. aus Prüfschritt 11.2.5.1 "Alternativen für komplexe Zeiger-Gesten" zu übertragen.
...
=== 2. Prüfung
Wenn die Accessibility Baseline Umgebungen einschließt, die bei Tastaturnutzung keine Einfingerbedienung anbieten (Android):
