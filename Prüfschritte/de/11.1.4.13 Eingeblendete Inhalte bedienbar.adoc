...
Die meisten mobilen Apps bieten keine Inhalte bei Fokusierung über Hover oder Tastatur, da meist für die Touchbedienung als dominante Nutzungsweise entwickelt wird. Dennoch sind solche Inhlate bei Nutzung mit gekoppelter Maus odr Tastatur möglich.
