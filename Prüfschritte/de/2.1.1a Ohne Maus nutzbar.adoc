...
Die Webseite bzw. Software soll auch ohne Maus- und Touch-Eingaben also
...
ifdef::env_embedded[2.1.2a "Keine Tastaturfalle".]
ifndef::env_embedded[]
<<2.1.2a Keine Tastaturfalle.adoc#,2.1.2a Keine Tastaturfalle>>.
endif::env_embedded[]
...
ifdef::env_embedded[2.4.3a "Schlüssige Reihenfolge bei der Tastaturbedienung"]
ifndef::env_embedded[]
...
Quelle: https://www.w3.org/WAI/WCAG21/Understanding/keyboard.html[Keyboard
