...
Beschriftungen sollen programmatisch (d.h. über die entsprechende Auszeichnung im Code) mit den zugehörigen Eingabefeldern verknüpft sein.

Visuell voneinander abgesetzte Gruppen von Formularelementen sind z. B. mithilfe von Überschriften sinnvoll strukturiert.

Ist bei Gruppen von Formularelementen eine Gruppenbeschriftung für das Verständnis der Beschriftung der einzelnen Formularelemente nötig, sollte deren programmatische Verfügbarkeit sichergestellt werden.
...
Diese Bezeichnungen sind dann nur von der Hilfstechnologie auswertbar, die entsprechenden Bezeichnungen sind nicht sichtbar.
...
=== Android
* https://developer.android.com/guide/topics/ui/accessibility/custom-views[Make custom views more accessible]
