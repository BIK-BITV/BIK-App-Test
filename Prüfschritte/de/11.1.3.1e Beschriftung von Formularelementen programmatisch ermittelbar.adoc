...
Sind Eingabefelder programmatisch nur über Platzhaltertexte beschriftet, muss die programmatische Beschriftung das Feld verständlich bezeichnen. Die Ausgabe muss auch erfolgen, wenn Nutzereingaben vorgenommen wurden, die den Plazuhaltertext ersetzen. Vergl. hierzu aber Prüfschritt 11.3.3.2 "Beschriftungen von Formularelementen vorhanden" (fie wird doe permanente Sichtbarkeit einer Beschriftung gefordert).
