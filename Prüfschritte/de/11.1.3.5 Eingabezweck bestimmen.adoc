...
== Quellen
In der https://github.com/w3c/matf/issues/2#issuecomment-2328477877[Mobile Accessibility Taskforce wird 11.1.3.5 diskutiert], ob und in welcher Form die Anforderung bei nativen Apps Anwendung finden kann.
