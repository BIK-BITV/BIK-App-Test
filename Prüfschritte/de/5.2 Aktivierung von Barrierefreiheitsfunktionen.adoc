...
spezielle Bedürfnisse von Nutzernenden füllt, soll die Aktivierung dieser
...
Barrierefreiheitsfunktionen, die von der zu testenden App, (also nicht vom Betriebssystem) bereitgestellt werden, sollen von ihrer potentiellen Nutzerschaft selbstständig aktivierbar sein.
