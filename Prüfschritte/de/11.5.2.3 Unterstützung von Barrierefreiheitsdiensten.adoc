...
. Gibt es im Standardzustand (also ohne explizite Aktivierung durch Nutzende aktive) Sprachausgaben, Vergrößerungsfunktionen oder andere in der App implementierte Funkionen, welche die die Nutzung von Barrierefreiheitsdienste des Betriebssystems beeinträchtigen? 
