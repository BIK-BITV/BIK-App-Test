= Prüfschritt 7.1.4 Eigenschaften von Untertiteln
...
. Falls die App bzw. die Einstellungsmöglichkeiten für Untertitel im Video-Player keine Anpassungsmöglichkeiten bieten, prüfen, ob sich die Änderung der Textgröße über die Bedienungshilfen des Betriebssystems auf die Darstellung der Untertitel auswirkt:
.. Android: Einstellungen > Bedienungshilfen > Text und Anzeige > Schriftgröße > am größten
.. iOS: Einstellungen > Bedienungshilfen > Anzeige und Textgröße > Größerer Text > Text im Schieberegler groß stellen
...
* ITU T.701.25: https://www.itu.int/rec/T-REC-T.701.25-202203-I/en[Guidance on the audio presentation of text in videos, including captions, subtitles and other on-screen text (itu.int)]. Empfehlungen für die Audio-Darstellung von Text in Videos, einschließlich Untertitel und andere Texte im Bild (ITU Version, Englisch, kostenlos)
