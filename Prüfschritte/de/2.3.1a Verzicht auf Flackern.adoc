...
Die Software-Ansicht enthält keine Elemente, die in einem Zeitraum von einer Sekunde
...
Gibt es in der Software-Ansicht flackernde Inhalte, die nicht spätestens nach
...
WCAG 2.1
http://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/G176#smallsafe1[Formel 1]
herangezogen werden.
...
Quelle: https://www.w3.org/WAI/WCAG21/Understanding/pause-stop-hide.html[
