...
=== 2. Prüfung
Hinweis: Für Grafiken und Bedienelemente ist eine Sichtprüfung ausreichend, wenn der Kontrast *sehr deutlich* über 3:1 liegt. Im Zweifelsfall immer den Color Contrast Analyzer auf Screenshots einsetzen.
...
. Bei der Kontrastmessung zu berücksichtigen sind ggf. auch verschiedene funktionale Zustände (etwa Checkboxen, Radio-Buttons, Reiter in Registerbereichen). Auch für solche Zustände ggf. Screenshots erstellen.
