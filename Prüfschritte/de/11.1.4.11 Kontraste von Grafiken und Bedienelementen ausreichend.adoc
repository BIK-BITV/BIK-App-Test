...
=== 2. Prüfung
Hinweis: Für die aufgeführten Prüfungen ist eine Sichtprüfung ausreichend, wenn der Kontrast sehr deutlich über 3:1 liegt. Im Zweifelsfall immer den Color Contrast Analyzer auf Screenshots einsetzen.
