...
. Grafische Bedienelemente (etwa Icons) in der Ansicht identifizieren, die keinen nebenstehenden Text haben, der dessen Bedeutung zusätzlich identifiziert. Reicht bei grafischen Bedienelementen mit nebenstehendem Text der Textkontrast nicht aus (gefordert ist hier 4,5:1), muss das Element selbst die Anforderung von 3:1 erfüllen.
. Sind die Kontraste zu angrenzenden Farben ausreichend (3:1 oder besser)? Zu berücksichtigen sind ggf. auch wechselnde Zustände nach Interaktion. Eine Ausnahme besteht für native Bedienelemente, deren Aussehen vom Betriebssystem bestimmt wird.
