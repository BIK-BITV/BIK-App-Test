...
. Grafische Bedienelemente (etwa Icons) in der Ansicht identifizieren, die keinen nebenstehenden Text haben, der dessen Bedeutung zusätzlich identifiziert. Reicht bei grafischen Bedienelementen mit nebenstehendem Text der Textkontrast nicht aus (gefordert idt hier 4,5:1), muss das Element selbst die Anforderung von 3:1 erfüllen.
