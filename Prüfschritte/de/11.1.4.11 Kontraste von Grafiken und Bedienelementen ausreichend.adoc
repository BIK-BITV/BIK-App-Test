...
Es ist zurzeit unklar, ob die Kontrastanforderung auch für native Bedienelemente wie iOS toggle switches gilt, oder ob für diese das Äquivalwent der Ausnahme for Bedienelemente gilt deren Aussehen durch den User Agent (den Browser) bestimmt wird. Wir haben hierzu ein https://github.com/w3c/wcag2ict/issues/94[Issue bei der WCAG2ICT Taskforce] angelegt.
