...
Eine Dark Mode Ansicht wird bei der Feststellung der Konformität nur berücksichtigt wenn sie explizit als Kontrastversion in der App selbst auswählbar ist und das Bedienelement selbst alle Barrierefreiheitsanforderungen erfüllt, und die Dark Mode Ansicht nicht selbst Kontrastmängel aufweist.
