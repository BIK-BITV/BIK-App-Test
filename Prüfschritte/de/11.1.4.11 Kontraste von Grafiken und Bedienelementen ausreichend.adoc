...
. Bei der Kontrastmessung zu berücksichtigen sind ggf. auch wechselnde Zustände nach Fokussierung oder Interaktion. Elemente bedienen bzw. fokussieren. Ändert sich der Kontrast, ggf. zusätzliche Screenshots erstellen.
...
. Sind bei den identifizierten Elementen die Kontraste zu angrenzenden Farben ausreichend (3:1 oder besser)? Eine Ausnahme besteht für native Bedienelemente, deren Aussehen vom Betriebssystem bestimmt wird.
