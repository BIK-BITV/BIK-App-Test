...
Wenn eine App Echtzeit-Sprachkommunikation bietet und auch Voice-Mail oder sprachbasierte Auswahlmenüs einsetzt, sollen etwaige Aufgaben auch ohne die Fähigkeit zum Hören und Sprechen durchführbar sein.
...
Der Prüfschritt ist anwendbar, wenn das Webangebot Echtzeit-Sprachkommunikation und gleichzeitig Voice-Mail oder interaktive Assistenzsysteme, z. B. für die
