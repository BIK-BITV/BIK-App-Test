...
soll diese in mindestens einem der folgenden Formate barrierefrei
...
Der Prüfschritt ist anwendbar, wenn für die App technische Dokumentation bereitgestellt wird.
