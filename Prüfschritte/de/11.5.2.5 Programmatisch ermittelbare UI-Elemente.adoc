...
Dann können die zum Beispiel druch einen Screenreader sinnvoll ausgegeben werden.
...
* *Zustand (state)* des Bedienelements: Zum Beispiel "aktiviert"/"nicht aktiviert", "ein"/"aus", ausgewählt / nicht ausgewählt, "67 Prozent"
* *Grenzen (boundary)* bzw. der Werte eines Bedienelements, z. B. "Prozent" (n von 100) oder Preisspanne 300 - 500
