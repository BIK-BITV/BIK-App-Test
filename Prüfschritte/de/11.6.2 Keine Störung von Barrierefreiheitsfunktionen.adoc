...
== Was wird geprüft?
Barierefreiheitsfunktionen des Betriebssystems wie Screenreader, Vergrößerung, oder Sprachsteuerung sollen nicht durch Funktionen der App gestört werden - es sei denn, Nutzende erwarten oder aktivieren solche App-Funktionen in der Nutzung der App.
