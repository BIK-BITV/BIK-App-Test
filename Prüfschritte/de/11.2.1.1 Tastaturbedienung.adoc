...
=== Unsere App auf die mobile Nutzung unterwegs ausgelegt, da hat man doch keine Tastatur. Ist dann nicht dieser Prüfschritt einfach nicht anwendbar?
Viele Apps für unterwegs werden auch zuhause oder am Arbeitsplatz genutzt, z.B. bei einer App für den öffentlichen Nahverkehr:
...
* um nutzerdefinierte Voreinstellungen vorzunehmen (z.B. häufige Ziele oder häufige Routen definieren)
