...
. Falls es sich um zuschaltbare Untertitel handelt: Prüfen, ob es in der App Einstellungsmöglichkeiten für die Darstellung der Untertitel gibt, etwa, um Schriftgröße, Schriftart (Font), Vorder- und Hintergrundfarbe, oder Transparenz des Untertitel-Bereichs anpassen zu können. 
. Falls die App bzw. die Einstellungsmöglichkeiten für Untertitel im Video-Player keine Anpassungsmöglichkeiten bieten, prüfen, ob sich die Änderung der Textgröße über die Bedienungshilfen des Betriebssystems audf die Darstellung der Untertitel auswirkt:
