...
Die technische Dokumentation ist ein wichtiger Bestandteil vieler Angebote, besonders bei komplexeren Apps. Damit auch Menschen mit Behinderungen sie gut nutzen können, sollte sie alle Anforderungen der Barrierefreiheit erfüllen.
...
=== 3. Hinweise
* Dokumentation bezieht sich in diesem Prüfschritt nur auf jene Dokumente, die Nutzenden auf Anfrage durch den Support zusätzlich zur Verfügung gestellt werden.
