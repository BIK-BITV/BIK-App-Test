...
übermitteln, eine Aktion anzuzeigen, eine Reaktion zu veranlassen oder ein
visuelles Element zu kennzeichnen.
...
<<1.4.3a Kontraste von Texten ausreichend.adoc#,1.4.3a Kontraste von Texten
ausreichend>> und
<<1.4.11a Kontraste von Grafiken und Bedienelementen ausreichend.adoc#,1.4.11a
Kontraste von Grafiken und Bedienelementen ausreichend>>.

. Abgrenzung zum Prüfschritt 1.3.3.a Ohne Bezug auf sensoriesche Merkmale nutzbar
+
...
Prüfschritt
<<1.3.3a Ohne Bezug auf sensorische Merkmale nutzbar.adoc#,1.3.3a Ohne Bezug
...
<<3.2.3a Konsistente Navigation.adoc#,3.2.3a Konsistente Navigation>> bzw.
...
somit noch nicht gegen diesen Prüfschritt 1.4.1a.
