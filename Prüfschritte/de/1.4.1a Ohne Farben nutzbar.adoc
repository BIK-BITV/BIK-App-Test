...
Prüfen, ob die Software-Ansicht Elemente enthält, die durch Farbgebung Informationen vermittelt. Beispiele dafür:
...
{empty}1. Abgrenzung zur Prüfung der Kontraste

In diesem Prüfschritt geht es nicht um die Prüfung der Kontraste. Dies ist Aufgabe der Prüfkriterien 1 "Kontraste von Texten ausreichend".

{empty}2. Abgrenzung zum Prüfschritt 1.3.3.a Ohne Bezug auf sensoriesche Merkmale nutzbar

In diesem Prüfschritt geht es nicht um die Prüfung von Verweisen auf Seiteninhalte mit Hilfe der Angabe von Farben. Die sinnesunabhängige Bereitstellung von Verweisen auf Seiteninhlate wird im Prüfschritt 1 Ohne Bezug auf sensorische Merkmale nutzbar geprüft.

{empty}2. Abgrenzung zur Prüfung des Markup
...
{empty}3. Abgrenzung zu fehlenden Hervorhebungen

In diesem Prüfschritt 1.4.1a geht es um die Farbunabhängigkeit vorhandener Seitenelemente.

Eine negative Bewertung ist also beispielsweise angebracht, wenn Links im Text nur durch die Farbe (und nicht zusätzlich durch Unterstreichung, Fettung oder vorangestellte Markierung) gekennzeichnet sind. Wenn Links im Text überhaupt nicht gekennzeichnet sind, ist der Prüfschritt dagegen nicht anwendbar. Das ist dann vielmehr ein Verstoß gegen Prüfschritt 1 "Konsistente Navigation"!

Entsprechend bei der Kennzeichnung der aktuellen Menüposition: Ein Webangebot, das die aktuelle Position überhaupt nicht anzeigt, verstößt damit noch nicht gegen dieses Prüfschritt 1.4.1a. Es erfüllt in der Regel allerdings Prüfschritt 1 "Position im Webauftritt klar" nicht.
