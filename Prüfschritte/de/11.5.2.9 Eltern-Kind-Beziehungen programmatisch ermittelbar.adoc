...
Der Prüfschritt wird also nur auf Tableisten und Toolbars im Fußbereich sowie auf Reiter-Elementen (Tabpanels) angewandt. Hier sollte der Screenreader bei Fokussierung des Kind-Tabs die Namen und Position des Tabs und die Anzahl der Tabs im Eltern-Element ausgeben.
