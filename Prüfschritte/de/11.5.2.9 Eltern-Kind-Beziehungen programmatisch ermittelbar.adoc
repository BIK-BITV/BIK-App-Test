...
=== 4. Bewertung
==== 4.1 Eher erfüllt: 
Elemente in Tableisten vermitteln nicht ihre Position innerhalb des Eltern-Elements und die Anzahl der Kind-Elemente in der Leiste (die Verfügbarkeit von Name, Rolle und Wert gehört zu Prüfschritt 11.4.1.2 und wird dort bewertet)
