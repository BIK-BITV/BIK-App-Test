...
Der Prüfschritt wird also nur auf Tablisten, isbesondere Tablisten oder Toolbars im Fußbereich, angewandt. Hier sollte der Screenreader bei Fokussierung des Kind-Tabs die Namen und Position des Tabs und die Anzahl der Tabs im Eltern-Element ausgeben.

=== 2. Prüfung
. Mittels Screenreader prüfen, ob Tablists und Toolbars die Position des Elements sowie die Gesamt-Anzahl von Tabs vermitteln (z.B. "Suchen, Tab, 5 von 5").
