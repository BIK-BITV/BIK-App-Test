...
Grafische Bedienelemente müssen Textalternativen haben. Textalternativen für interaktive Schaltflächen oder Teaserbilder sollen deren Aktion bzw. Ziel bezeichnen.
