...
Grafische Bedienelemente müssen Textalternativen haben. Textalternativen für  Schaltflächen oder interaktive Teaserbilder sollen deren Aktion bzw. Ziel bezeichnen.
