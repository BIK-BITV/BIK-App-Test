...
Grafische Bedienelemente müssen Textalternativen haben. Textalternativen für verlinkte Grafiken oder Teaserbilder sollen das Ziel des Links bezeichnen. Textalternativen für grafische Schaltflächen (Buttons) sollen die Aktion bezeichnen, die der Button auslöst.
...
. Bei aktivierbaren informationstragenden Grafiken wird der Inhalt benannt und Linkziel bzw. Aktion beschrieben (etwa: "Portraitfoto Helga Müller - öffnet vergrößerte Ansicht").
...
* Beschreibung des abgebildeten Gegenstandes und Ziel des Links bzw. der Aktion in der Textalternative (wenn beides wichtig ist)
