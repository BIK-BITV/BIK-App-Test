...
* Wenn native Bedienelemente der Plattform zum Einsatz kommen, sind ggf. Kontrastmängel bei der Fokushervorhebung auf diesen nativen Elementen bzw. deren Kind-Elementen zur akzepieren. Die Verwendung nativer Elemente unterstützt in der Regel die barrierefreie Umsetzung und Nutzbarkeit von Bedienelementen auch beim Einsatz von Hilfsmitteln wie Screenreader. Die Mängel müssten von den Herstellern der Plattform behoben werden. Entwickler sollten sich wegen Mängeln der Plattform nicht gezwungen sehen, Custom-Elemente zu entwickeln, um ggf. Defizite bei der Fokushervorhebung auszugleichen.
