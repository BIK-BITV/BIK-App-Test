...
. Mit der Tabulatortaste zu allen interaktiven Elementen navigieren. Wo diese weitere Auswahlen zulassen, etwa bei Tabpanels, Menüs oder Auswhallisten, mit den Pfeiltasten oder ggf. dem Tabulator zu Tabs bzw. Optionen navigieren.
