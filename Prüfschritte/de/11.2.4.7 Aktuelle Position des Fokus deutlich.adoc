...
Dennoch ist die Anzeige des Fokus nicht allein Sache des Betriebssystems. Bei den mobilen Betriebssystmen ist die Standatrdanzeige nicht kontradtreich genug und für Menschen mut Sehbehinderungen nicht oder nur schlecht wahrnwehmbar.
