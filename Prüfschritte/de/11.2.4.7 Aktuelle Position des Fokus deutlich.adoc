...
Der Fokus-Indikator muss außerdem einen Kontrastunterscheid von mindestens 3:1 zwischen fokussiertem und nicht fokussiertem Zustand haben. 
Meist ist das einfach der Kontrast zwischen dem Fokus-Indikator und dem Hintergrund. 
Wenn jedoch der Fokuszustand durch die Änderung der Farbe einer Schaltfläche angezeigt wird, 
