...
* Eingabefelder, die sich klar auf Nutzende selbst beziehen, unterstützen indirekt das Verständis des Zweck des Eingabezwecks, z.B. über die Anzeige einer anderen Tastatur oder Textvorschläge (Autofill).

==== Eher erfüllt: 
* Eingabefelder generieren keine Eingabevorschläge und zeigen keine abweichende Tastatur an.

==== Nicht anwendbar:
* Eingabefelder beziehen sich eindeutig auf die Nutzenden selbst.
...
The semantic meaning for a text input area]. (zur Zeit nur auf
Englisch verfügbar)
