...
In iOS/iPadOS und Android können Eingabefelder teilweise für einen bestimmten Zweck ausgezeichnet werden. Z. B. für die Eingabe einer E-Mail-Adresse, Nummern für PIN-Code-Eingabe, URL, usw. Hier kann dann das Betriebssystem u. a. eine optimierte Tastatur einblenden.
