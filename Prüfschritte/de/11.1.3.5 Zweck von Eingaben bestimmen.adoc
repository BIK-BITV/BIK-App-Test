...
In iOS/iPadOS und Android können Eingabefelder teilweise für bestimmte spezifische Eingabe-Typen ausgezeichnet werden, etwa für die Eingabe einer E-Mail-Adresse, für einen PIN-Code-Eingabe oder für eine URL. Für diese spezifischen Eingabefelder kann das Betriebssystem dann eine optimierte Tastatur einblenden. Dies unterstützt die Identifizierung des Eingabezwecks, deckt sich jedoch nicht der vollen Intention der Anforderung.
