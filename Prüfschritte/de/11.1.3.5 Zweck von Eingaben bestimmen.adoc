...
Die Festlegung des Eingabezwecks (sobald dies möglich ist) wirde Bedienungshilfen-Einstellungen ermöglichen, die bei Formularfeldern, die sich auf Daten der Nutzenden selbstbeziehen, zusätzliche Informationen anzuzeigen, und zwar unabhängig vom der jeweils gewählten Beschriftung des Feldes und unabhängig von der natürlichen Sprache des Angebots.

Zusätzliche Informationen könnten etwa Bilder bzw. Icons sein, die über bzw. vor dem jeweiligen Eingabefeld angezeigt würden, etwa wenn Nutzende dies voreinstellen. Für Menschen, die Schwierigkeiten mit dem Lesen haben oder bevorzugt über Bilder kommunizieren, erleichtert dies eine Identifizierung von nutzerbezogenen Feldern in Formularen.
