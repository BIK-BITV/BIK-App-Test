...
Native mobile Plattformen verfügen über eine Funktion "größerer dynamischer Text" das bedeutet, eine Funktion zur Textvergrößerung. Apps, die diese Funktion unterstützen, passen sich an die festgelegte Lesegröße an. Diese Funktion wird häufig verwendet, da die Bedürfnisse von sehbehinderten Nutzenden durch die Zoom-Funktion der Plattform nicht vollständig abgedeckt werden. Wir empfehlen daher dringend, native Apps so umzusetzen, dass sie diese Funktion unterstützen. Probleme die bei der Nutzung der dynamischen Textfunktion entstehen, sollten zumindest angemerkt werden.
