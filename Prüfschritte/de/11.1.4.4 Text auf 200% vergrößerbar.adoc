...
Android develop - Element magnification]. Code-Beispiele für den Einsatz von Scale-independent Pixels für die Textvergrößerung und Anpassung der Containergröper basierend auf Nutzereinstellungen.
