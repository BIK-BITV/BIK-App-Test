...
Native mobile Plattformen verfügen über eine Funktion "größerer dynamischer Text", das bedeutet, eine Funktion zur Textvergrößerung. Apps, die dynamische Fonts verwenden, passen diese an die eingestellte Schriftgröße an. Diese Funktion wird häufig verwendet, da die Bedürfnisse von sehbehinderten Nutzenden durch die Zoom-Funktion der Plattform nicht vollständig abgedeckt werden. Daher ist es sinnvoll, native Apps so umzusetzen, dass sie diese Funktion unterstützen.
