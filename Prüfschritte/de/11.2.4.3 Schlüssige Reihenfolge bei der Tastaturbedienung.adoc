...
ifdef::env_embedded[2.4.7a "Aktuelle Position des Fokus deutlich".]
ifndef::env_embedded[]
...
ifdef::env_embedded[3.3.3a "Hilfe bei Fehlern""]
ifndef::env_embedded[]
  <<3.3.3a Hilfe bei Fehlern.adoc#,3.3.3a Hilfe bei Fehlern>>
endif::env_embedded[]
  oder
