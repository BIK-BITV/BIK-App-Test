...
Ggf. müssen erst Bereiche mit Tabulator oder Pfeiltasten erreicht bzw. geöffnet und dann zwischen Tabulator- und Pfeiltasten-Navigation gewechselt werden. Bei einer nicht linearen (zweidimensionalen) Navigation wie in einer Gitterstruktur kann man dagegen i.d.R. nicht von einer schlüssigen Reihenfolge sprechen, da hier der Weg zur Fokussierung nur visuell vermittelt wird und  linear kaum nachvollziehbar ist.
