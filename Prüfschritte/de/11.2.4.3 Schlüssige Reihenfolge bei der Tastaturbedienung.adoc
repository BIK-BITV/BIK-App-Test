...
. Die interaktiven Elemente der Ansicht werden mit der Tabulatortaste bzw. auch mit den Pfeiltasten durchlaufen. Rückwärts-Tabben oder die Aktivierung der entgegengesetzten Pfeiltaste sollen die Elemente in der Regel in der gleichen Reihenfolge rückwärts durchlaufen.
