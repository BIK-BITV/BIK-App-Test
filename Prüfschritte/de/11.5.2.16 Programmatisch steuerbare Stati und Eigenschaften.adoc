...
=== 3. Hinweise
In der Regel kann die Bewertung bei Prüfgschritt 11.4.1.2 hier übernommen werden. Kann bei eingeschaltetem Screenreader der Wert nicht geändert werden, sind sowohl Prüfschritt 11.4.1.2 als auch dieser Prüfschritt nicht erfüllt. Dieser Prüfschritt betrachtet die Möglichkeit, den Wert wirksam zu setzen, nicht die Ausgabe des geänderten Wertes. Dies ist Gegenstand bvon Prüfschritt 11.5.2.16.
