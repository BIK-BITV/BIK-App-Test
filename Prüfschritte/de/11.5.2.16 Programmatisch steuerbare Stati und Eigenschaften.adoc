...
Die Prüfung erfolgt im Wesentlichen in der gleichen Weise wie beim Prüfschritt 11.4.1.2 "Name, Rolle, Wert verfügbar". Hier wird bewertet, ob sich Zustände und Eigenschaften von Bedienelementen auch bei aktivierten Hilfsmitteln modifizieren lassen. Beispiele: 
