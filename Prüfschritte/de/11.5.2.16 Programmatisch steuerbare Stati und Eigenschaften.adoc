...
Die Prüfung erfolgt im Wesentlichen in der gleichen Weise wie beim Prüfschritt 11.4.1.2 "Name, Rolle, Wert verfügbar". Hier wird speziell geprüft, ob sich *Zustände und Eigenschaften* von Bedienelementen auch bei aktivierten Hilfsmitteln modifizieren lassen. Beispiele: 
...
Hilfsmittel-Nutzenden soll es möglich sein, alle Zustände und Eigenschaften von Bedienelementen zu ändern, die sich ohne die Nutzung von Hilfsmitteln ändern lassen. Selbst-gestaltete interaktive Elemente (Custom-Elemente und -Widgets) sollen sich ebenso bedienen lassen wie native Elemente.
