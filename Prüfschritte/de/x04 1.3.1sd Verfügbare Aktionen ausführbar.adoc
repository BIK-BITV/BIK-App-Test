= x04 1.3.1sd Verfügbare Aktionen ausführbar
...
== Was wird geprüft?
Die im Prüfschritt
ifdef::env_embedded[x03 1.3.1sc "Aktionen programmatisch ermittelbar"]
ifndef::env_embedded[]
  <<x03 1.3.1sc Aktionen programmatisch ermittelbar.adoc#,x03 1.3.1sc Aktionen
