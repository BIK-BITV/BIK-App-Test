...
auflisten und dessen Nutzung erklären.
...
oder gar nicht mit assistiven Technologien nutzen lassen.
...
sofern sie in der App implementiert sind und nicht etwa über die Systemumbegbung bereitgestellt werden, etwa:
** Vorlesefunktion
