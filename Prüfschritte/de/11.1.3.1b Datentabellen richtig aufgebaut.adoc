...
* Eine verikale Navigation über Wischgesten ist in der Regel nicht möglich. Mittles Tastatur wird ggf, die Pfeiltzastennaivgation zwischen Zellen unterstützt.
