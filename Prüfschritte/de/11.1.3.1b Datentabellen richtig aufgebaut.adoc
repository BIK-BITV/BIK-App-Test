...
Personen, die Apps entwickeln, können das Protokoll https://developer.apple.com/documentation/uikit/uiaccessibilitycontainerdatatable[
...
* Android: Developers.google.com: https://developers.google.com/chart/interactive/docs/datatables_dataviews[DataTables und DataViews]
