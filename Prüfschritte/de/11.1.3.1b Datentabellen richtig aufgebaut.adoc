...
Sehbehinderte und blinde Nutzende erschließen sich das Angebot von Datentabellen dagegen eher analytisch. Sie entwickeln ausgehend von den Überschriften eine Vorstellung vom Aufbau der Tabelle und navigieren Tabellenzellen horizonal und vertikal. Bei jeder Zelle wird dann die jeweils neue Spalten- oder zeilenüberschrift ausgegeben. 
...
Der Prüfschritt ist immer anwendbar, wenn Tabellen in der App-Ansicht vorhanden sind. Diese tauchen häufiger in Webviews auf.
