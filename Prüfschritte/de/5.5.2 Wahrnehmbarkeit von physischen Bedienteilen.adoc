= 5.5.2 Wahrnehmbarkeit von physischen Bedienteilen
...
Kriterium 5.5.2 Operable parts discernibility
...
(Aus EN 301 549 V3.2.1 Abschnitt 5.5.2 Operable parts discernibility)
