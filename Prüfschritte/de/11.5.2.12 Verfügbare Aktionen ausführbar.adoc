...
. Manchmal sind mehrere Aktivierungsgeste verfügbar, die bei Fokussierung ausgegeben werden, etwa "Zum Auswählen doppeltippen, Zum Tickets kaufen doppeltippen und halten".
. Wird die programmatisch verfügbare Funktion nach Aktivierung auch ausgeführt? 
