= Prüfschritt 11.2.3.1 Verzicht auf Flackern
...
=== 3. Hinweise Zur Einschätzung der Größe des flackernden Bereichs kann, wenn nötig, die
WCAG 2.1
http://www.w3.org/TR/2008/NOTE-WCAG20-TECHS-20081211/G176#smallsafe1[Formel 1]
herangezogen werden.

=== 4. Bewertung
Die Ansicht enthält Elemente, die häufiger als dreimal pro Sekunde flackern.
