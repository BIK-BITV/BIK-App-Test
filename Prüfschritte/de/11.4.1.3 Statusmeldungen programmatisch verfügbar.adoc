...
* WCAG 2.1, Definition einer Statusmeldung: https://www.w3.org/TR/WCAG/#dfn-status-messages[Status Messages]
* Appt.org: https://appt.org/en/guidelines/wcag/success-criterion-4-1-3[Use Status Messages]
