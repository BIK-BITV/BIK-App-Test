...
geprüft. 11.4.1.2 ist weiter gefasst, denn hier wird explizit verlangt, dass geänderte Werte Hilfsmitteln zur Verfügung stehen. Wenn also bei der Prüfung in 11.4.1.2 bei Bedienelementen Auszeichnungsmängel negativ bewertet werden, wird die Bewertung in diesen Prüfschritt übertragen.
