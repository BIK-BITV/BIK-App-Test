...
. Bedienelemente und Bearbeitungsoptionen werden mit dem Screenreader und dokumentierten Gesten aktiviert, Werte werden geändert. Dazu gehören prinzpiell auch geänderte Werte bei der Auswahl und Bearbeitung von Text.
