...
* Nach Aktivierung einer einer Einstellungsoption wird der eingestellte Wert ausgegeben
* Nach Aktivieren des Reiters eines Tabpanels wird vor dem Namen des jeweiligen Reiters "Auswahl" ausgegeben
* Nach dem Ändern des Wertes eines interaktiven Reglers (z.B zur Einstellung von Lautstärke, Preisspanne, Zeitraum usw.) wird der geänderte Wert ausgegeben
...
. Erfolgt eine Ausgabe der geänderten Werte bzw. Zustände?
