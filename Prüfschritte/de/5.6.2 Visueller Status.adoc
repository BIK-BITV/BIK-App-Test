...
Für die Nutzung mancher Apps können bestimmte Zustände von Umschaltern am Ausgabegerät selbst relevant sin, z.B. zum Stummschalten des Geräts oder Feststellen der Bildschirmausrichtung. Auch diese Zustände sollen visuell ermittelbar sein.
