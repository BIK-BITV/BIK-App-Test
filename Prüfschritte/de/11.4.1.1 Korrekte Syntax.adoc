...
=== Prüfung
Es wird lediglich geprüft, ob die App Webviews enthält. Ist das der Fall, ist der Prüfschritt erfüllt. Sind keine Webviews vorhanden, ist der Prüfschritt nicht anwendbar.

=== Hinweise

* Wenn nicht eindeutig festzustellen ist, ob die App Webviews enthäht, sollte der Prüfschritt mit "nicht anwendbar" bewertet werden.
