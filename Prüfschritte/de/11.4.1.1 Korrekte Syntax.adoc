...
=== Prüfung
Es wird lediglich geprüft, ob die App Webviews enthält. Ein Anzeichen dafür ist die Ausgabe "Webview" bei Fokussierung des Webviews sein, ebenso die Ausgabe von Elementen, die in nativen Apps in de Regel nicht vorkommen, z.B. Überschriften auf verschiedenen Ebenen. 
