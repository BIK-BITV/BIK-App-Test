...
Auch Umschalter auf dem Ausgabegerät selbst können für die Nutzung der App relevant sein, etwa physische Umschalter für das Stummschalten oder das Feststellen der Bildschirmausrichtung. Auch diese Zustände sollen taktil oder auditiv ermittelbar sein.
