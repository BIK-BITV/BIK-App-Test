...
=== 4. Bewertung
==== Nicht erfüllt:
* In der App ist ein Bedienelement vorhanden, dass den Kontext der Ausgabe oder Eingabe beeinflusst und dessen Zustand nicht programmatisch ermittelbar ist. In diesem Fall sind sowohl dieser Prüfschritt als auch 11.4.1.2 "Name, Rolle, Wert verfügbar" nicht erfüllt.
