= Prüfschritt 11.2.5.4 Alternativen für Bewegungsaktivierung
...
Gegebenenfalls kann Anwendungssoftware diese Anforderung erfüllen, indem sie
Betriebssystemeinstellungen unterstützen, die es dem Benutzer ermöglichen,
...
Deshalb ist es wichtig, dass sich von der Software bereitgestellte motorische
...
Der Prüfschritt ist anwendbar, wenn Anwendungssoftware bestimmte
...
. Über Bewegungen prüfen, ob die Software in irgend einer Weise auf
...
* Von der Software definierte Bewegungseingaben haben eine alternative
  ...
  Nutzer wirkungsvoll deaktivieren
  (ggf. über Einstellungen des Betriebssystems).
