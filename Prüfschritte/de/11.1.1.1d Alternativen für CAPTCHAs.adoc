...
In bildbasierten CAPTCHAs werden Bilder von Zeichenfolgen eingesetzt, welche Nutzende als Text eingeben müssen, um bestimmte Bereiche der App zu erreichen.
Für blinde und sehbehinderte Nutzende sind solche CAPTCHAs nicht zugänglich. Audio-Captchas sind für höreingeschränkte Nutzende nicht zugänglich. Deshalb soll in beiden Fällen mindestens eine CAPTCHA-Alternative angeboten werden.
