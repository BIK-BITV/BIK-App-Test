...
Für die Bewertung ist das https://www.w3.org/TR/WCAG22/#dfn-contrast-ratio[Kontrastverhältnis] (relative luminosity) maßgeblich, das anhand der in den WCAG 2.1 definierten Formel berechnet wird. Der https://www.bitvtest.de/bitv_test/das_testverfahren_im_detail/werkzeugliste.html#cca[Color Contrast Analyzer] wendet diese Formel an und stellt das Ergebnis dar.
