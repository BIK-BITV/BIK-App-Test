= Prüfschritt 6.5.3 Bildwiederholfrequenz bei Videotelefonie bei Videotelefonie
...
Eine genaue Methode zur Messung der unterstützten Bildwiederholfrequenz ist noch offen. Hinweise zur Weiterentwicklung des Prüfschritts können Sie auf GitHub
https://github.com/BIK-BITV/BIK-App-Test/issues[in einem Issue] hinterlassen.
