= 11.1.2.1 Alternativen für Audiodateien und stumme Videos
...
Der Prüfschritt ist anwendbar, wenn Audiodateien oder stumme Videodateien in
der App-Ansicht eingebunden sind.
