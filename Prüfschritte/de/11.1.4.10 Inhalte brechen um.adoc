...
Wenn Apps angepasste Layouts für breitere Viewports bieten, sollten sich das Layout an schmale Viewports anpassen, etwa, wenn Apps nebeneinander in Splitscreen-Ansichten dargestellt werden, Wenn die AUsrichtung des Geräts geändert wird. 
