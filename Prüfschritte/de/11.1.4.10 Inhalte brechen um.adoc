...
* WCAG 1.4.10 Reflow, Understanding https://www.w3.org/WAI/WCAG21/Understanding/reflow.html[Understanding Reflow]
(zur Zeit nur auf Englisch verfügbar)
* Appt Guidelines: https://appt.org/en/guidelines/wcag/success-criterion-1-4-10[
