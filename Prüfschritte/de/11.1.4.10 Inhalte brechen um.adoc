...
Laut EN 301 549 Version 3.1.1 ist dieser Prüfschritt auf Software und damit auch auf mobile Apps anwendbar. 
...
So hat das iPhone 14 eine Viewportbreite von 390 CSS-Pixeln. Das Samsung Galaxy S21 Ultra hat eine Viewportbreite von 384 CSS-Pixeln.
