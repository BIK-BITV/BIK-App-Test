...
* Mit einem Auswahlkreis mit 24px Durchmesser das Ziel umschließen. Ist das Ziel größer als der Kreis ist es groß genug. Ist es kleiner, den Kreis mittig auf dem Ziel platzieren.
