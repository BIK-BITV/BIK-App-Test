...
kann im Zweifelsfall ein Screenshot auf den Desktop übertragen und dort analysiert werden. 
...
* Eine Mindestgröße von 24 mal 24 CSS-Pixel bedeutet: Das Ziel ist so groß, dass ein Kreis mit einem Durchmesser von 24px über dem Ziel gezeichnet werden kann und dieser Kreis nicht mit einem ebensolchen Kreis über benachbarten Elementen überlappt. 
...
und hat auf jeder Seite einen Bereich von 4 Pixeln, der ebenfalls auf die Zeigereingabe reagiert. Dies summiert sich zu einer Zielfläche von 24 x 24 Pixeln.
...
* Den Screenshot auf die errechnete CSS Viewport-Breite verkleinern (für das genannte Beispiel 414 CSS Pixel).
...
* Sind andere Ziele so benachbart, dass ein solcher Kreis den Kreis über dem untersuchten Ziel möglicherwiese überlagert, Kreis transparent füllen oder Kante zeichnen und dies für benachbarte Ziele wiederholen
* Wenn sich die Kreise über den Zielen überlappen, ist die Anforderung nicht erfüllt.
