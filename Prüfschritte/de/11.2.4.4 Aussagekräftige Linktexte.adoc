...
. Über die vertikale Drei-Finger-Wischgeste (oder die äqivalente vertikale Ein-Finger-Wischgeste Nach-oben-dann-nach-unten bzw. umgekehrt) die Option "Links" einstellen
