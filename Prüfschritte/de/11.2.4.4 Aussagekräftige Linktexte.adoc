...
Links spielen in nativen Apps vor allem in Webviews eine Rolle. Ziel oder Zweck des Links sollen aus dem Linktext hervorgehen oder aus dem direkten Kontext des Links ermittelbar sein.

Falls Links nicht auf andere Ansichten der App verweisen, soll der Link zusätzlich zum aussagekräftigen Linktext einen  Hinweis auf das Ziel(format) geben, z.B. "öffnet in Browser" oder "PDF".
