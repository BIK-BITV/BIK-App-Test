...
"Zeiger" schließt dabei indirekte Eingaben mittels Mauszeiger ebenso wie direkte Eingaben ein, etwa mit dem Finger auf einem Touchscreen oder mit dem Stift auf einem Grafiktablett.
