...
* Apppt.org: https://appt.org/en/guidelines/wcag/success-criterion-2-5-1#provide-alternatives-for-gestures[Pointer Gestures: Provide altenatives for gestures] (mehrere Entwicklungsumgebungen)
