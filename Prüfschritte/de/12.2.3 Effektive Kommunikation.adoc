...
Wie dieser Prüfschritt in der Praxis berücksichtigt werden kann, ist noch nicht vollständig geklärt. Auf GitHub können Sie https://github.com/BIK-BITV/BIK-App-Test/issues[Hinweise zu diesem Prüfschritt
hinterlassen].
