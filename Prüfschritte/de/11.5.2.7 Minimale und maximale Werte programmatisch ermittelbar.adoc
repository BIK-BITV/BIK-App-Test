...
Falls für Formularelemente minimale oder maximale Eingabewerte programmatisch festgelegt sind und visuell vermittelt werden, muss diese Information auch programmatisch verfügbar sein.
