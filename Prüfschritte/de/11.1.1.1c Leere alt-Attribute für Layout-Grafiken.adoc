...
* Siehe 
ifdef::env_embedded[Prüfschritt 11.1.1a "Alternativtexte für Bedienelemente"]
ifndef::env_embedded[]
  <<11.1.1.1a Alternativtexte für Bedienelemente.adoc#_formulierung_bitv_2_0,
  Prüfschritt 11.1.1a Alternativtexte für Bedienelemente>>
endif::env_embedded[]
