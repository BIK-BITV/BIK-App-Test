...
=== 3. Bewertung
==== Erfüllt:
Informationen sind nicht nur über die Farbe vermittelt, sondern auch über andere Merkmale die Form, zusätzliche Merkmale wir Unterstreichung oder Einrückung, oder beigestellten Text
