...
=== 3. Bewertung
==== Erfüllt:
Information wird nicht nur über die Farbe vermittelt, sondern auch über andere zusätzliche Merkmale, etwa die Form, der Rahmen, eine Textauszeichnung oder Einrückung, oder beigestellten Text.

==== Nicht erfüllt:
Information wird ausschließlich über Farbe vermittelt. Der Kontrastunterscheid der für die Unterscheidung relevanten Farben liegt unter 3:1.
...
In diesem Prüfschritt 11.1.4.1a geht es um die Farbunabhängigkeit vorhandener UI-Elemente.

Eine negative Bewertung ist also beispielsweise angebracht, wenn Links im Fließtext nur durch die Farbe (und nicht zusätzlich durch Unterstreichung, Fettung oder vorangestellte Markierung) gekennzeichnet sind und der Kontrastunterschied zum umgebenden Test weinger als 3:1 beträgt.
