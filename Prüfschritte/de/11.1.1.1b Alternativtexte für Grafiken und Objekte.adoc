...
* https://a11y-guidelines.orange.com/en/mobile/android/development/vocal-navigation/#do-not-vocalize-the-decorative-and-hidden-elements[Orange Digital Accessibility: Do not vocalize the decorative and hidden elements]
