...
Informative Grafiken und Bilder müssen Textalternativen haben. Die Textalternativen ersetzen das Bild, sie sollen (soweit wie möglich) die gleiche Information vermitteln wie das Bild. Sind Grafiken lediglich dekorativ, sollten sie keine Textalternative haben, so dass sie in assistiven Technologien nicht ausgegeben werden.
...
Der Prüfschritt ist anwendbar, wenn nicht interaktive Grafiken oder Bilder, Video-Vorschaubilder oder Multimedia-Objekte vorhanden sind.
