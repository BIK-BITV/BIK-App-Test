...
Informative Grafiken und Bilder müssen mit Textalternativen versehen werden. Die Textalternativen ersetzen das Bild, sie sollen (wenn möglich) dieselbe Aufgabe erfüllen wie das Bild.
...
Textalternative. Wenn die Grafik verlinkt ist, ist das natürlich ohnehin so. Dies ermöglicht blinden und sehenden Nutzern, sich gemeinsam auf diese Elemente
zu beziehen. Die Textalternative muss aber nicht expliziter sein als das, was für den sehenden Nutzer erkenntlich ist.
...
. Prüfen, ob der Screenreader bei den entsprechenden Elementen auf dem Bildschirm aussagekräftige Textalternativen ausgibt.
...
* Bei Diagrammen oder technischen Zeichnungen sind unter Umständen ausführlichere Erläuterungen erforderlich.
  Textalternativen sind dafür nicht geeignet, sie sollen in der Regel 80 Zeichen nicht überschreiten. In der Textalternative steht dann nur, was dargestellt ist und wo (etwa: "Details im anschließenden Text"), die Erläuterung steht in Kontext des Bildes. Der Kontext kann zum Beispiel ein unmittelbar folgender Inhalt (Text oder Tabelle), ein Ausklappbereich oder auch ein Link zu einer Ansicht sein, die die ausführliche Alternative enthält.
...
Eine kurze Textalternative mit Bezeichnung des Bildes ist auch bei Nutzung von Textalternativen im Kontext erforderlich. Die Textalternative sagt, dass an dieser Stelle etwas Bestimmtes abgebildet ist, er macht klar, worauf sich die Erläuterung im Kontext bezieht.
