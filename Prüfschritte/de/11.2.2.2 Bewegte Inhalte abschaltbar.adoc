...
Nutzende haben Schwierigkeiten, Apps zu nutzen, die mit blinkenden oder sich bewegenden Elementen (zum Beispiel Werbung) ausgestattet sind. Solche Elemente lenken ab. Der Benutzer kann sich möglicherweise nicht auf andere Inhalte konzentrieren.
...
Falls die zu testende Ansicht in der App blinkende, bewegte oder automatisch aktualisierte Inhalte enthält, die parallel zu anderen Inhalten dargestellt wird, zum Beispiel Nachrichten-Aufmacher (Teaser), laufende Texte, oder animierte Werbung:
...
* Die Schaltfläche oder die Anweisung, mit der man die Bewegung anhalten kann, muss eindeutig sein und deutlich sichtbar am Beginn der Ansicht oder direkt
