...
Notwendige simultane Aktionen bei der bedienung in einem Modus sind kein Fehler im Sinne dieses Prüfschritts, solange es einen anderen Bedienungsmodus gibt, der die bedienung ohne simulatane Aktioben anbietet. Dies ist bei der Vielzahl der Eingabemöglichkeiten und Kombinationen unter diesen nur schwer vollständig zu prüfen.
...
Der Prüfschritt ist immer anwendbar, wenn die Accessibility Baseline Umgebungen einschließt, die bei Tastaturnutzung keine Einfingerbedienung anbietet (z.B. Android). Das Ergebnis ist ggf. aus Prüfschritt 11.2.5.1 "Alternativen für komplexe Zeiger-Gesten" übertragen.
...
. Bezüglich der Prüfung von Aktionen bei der Toucheingabe wird das Ergebnis von 11.2.5.1 hierhin übertragen, wenn es Fehler durch den Einsatz von Mehrfingergesten ohne Einfinger-bedienbare Alternativen gibt.
