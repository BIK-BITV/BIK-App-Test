...
. Bezüglich der Prüfung von Aktionen bei der Toucheingabe wird das Ergebnis von 11.2.5.1 hierhin übertragen, wenn es Fehler durch den Einsatz von Mehrfingergesten ohne Einfiger-bedienbare Alternativen gibt.
