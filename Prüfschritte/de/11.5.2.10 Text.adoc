...
Die Appp soll sowohl sequenziell als auch pber direkte Touchberührung bedienbar sein, z.B. wenn der Ort von Bedienelementen bekann ist und so die Navigation abgekürzt werden kann. Dafür ist es wichtig, das sequenziell erreichte Inhalte auch im Viewport angezeigt werden so dass sie über Touch erreichbar sind.
